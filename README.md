...
|------|------------|-------|------|-------------|
| 2015 | IEEE ICCV | **[FlowNet: Learning Optical Flow with Convolutional Networks](https://arxiv.org/abs/1504.06852)** | [![GitHub](https://img.shields.io/badge/GitHub-flownet--name-black?logo=github)](https://github.com/lmb-freiburg/flownet2) | Optical flow detection by DL |
...
| 2025 | IEEE ICCV | **[Back on Track: Bundle Adjustment for Dynamic Scene Reconstruction](https://arxiv.org/abs/2504.14516)** | [![GitHub](https://img.shields.io/badge/GitHub-BA-dynamic--name-black?logo=github)](https://github.com/wrchen530/batrack) | Reconstruction with dynamic objects |
